<div class="container bg-white border mx-auto my-4">
    ...
    <div class="border shadow-xl mx-4 mt-0 mb-16 px-4 py-8 rounded-lg">
      <div class="flex justify-center bg-white mx-0 mb-4 px-0 py-0">
        <button class="bg-blue-500 border-2 border-blue-500 hover:border-blue-700 text-white font-bold py-2 px-2 rounded-lg hover:bg-blue-700" onclick="window.location.href='{{ route('patients.create') }}'">
          Crear Paciente
        </button>
